...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proyecto.proyecto_activo'
        db.add_column('fed_proyecto', 'proyecto_activo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proyecto.proyecto_activo'
        db.delete_column('fed_proyecto', 'proyecto_activo')
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 24, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 24, 0, 0)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
