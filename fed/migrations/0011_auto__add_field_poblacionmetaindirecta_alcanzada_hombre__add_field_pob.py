...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoblacionMetaIndirecta.alcanzada_hombre'
        db.add_column('fed_poblacionmetaindirecta', 'alcanzada_hombre',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Adding field 'PoblacionMetaIndirecta.alcanzada_mujer'
        db.add_column('fed_poblacionmetaindirecta', 'alcanzada_mujer',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Adding field 'PoblacionMetaDirecta.alcanzada_hombre'
        db.add_column('fed_poblacionmetadirecta', 'alcanzada_hombre',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Adding field 'PoblacionMetaDirecta.alcanzada_mujer'
        db.add_column('fed_poblacionmetadirecta', 'alcanzada_mujer',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoblacionMetaIndirecta.alcanzada_hombre'
        db.delete_column('fed_poblacionmetaindirecta', 'alcanzada_hombre')

        # Deleting field 'PoblacionMetaIndirecta.alcanzada_mujer'
        db.delete_column('fed_poblacionmetaindirecta', 'alcanzada_mujer')

        # Deleting field 'PoblacionMetaDirecta.alcanzada_hombre'
        db.delete_column('fed_poblacionmetadirecta', 'alcanzada_hombre')

        # Deleting field 'PoblacionMetaDirecta.alcanzada_mujer'
        db.delete_column('fed_poblacionmetadirecta', 'alcanzada_mujer')
    ...
    models = {
        ...
        'fed.poblacionmetadirecta': {
            ...
            'alcanzada_hombre': ('django.db.models.fields.IntegerField', [], {}),
            'alcanzada_mujer': ('django.db.models.fields.IntegerField', [], {}),
