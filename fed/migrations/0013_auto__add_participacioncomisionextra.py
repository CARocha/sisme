...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipacionComisionExtra'
        db.create_table('fed_participacioncomisionextra', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fed.Proyecto'])),
            ('comision', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ambito_territorial', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('fed', ['ParticipacionComisionExtra'])

        # Adding M2M table for field municipios on 'ParticipacionComisionExtra'
        db.create_table('fed_participacioncomisionextra_municipios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('participacioncomisionextra', models.ForeignKey(orm['fed.participacioncomisionextra'], null=False)),
            ('municipio', models.ForeignKey(orm['lugar.municipio'], null=False))
        ))
        db.create_unique('fed_participacioncomisionextra_municipios', ['participacioncomisionextra_id', 'municipio_id'])


    def backwards(self, orm):
        # Deleting model 'ParticipacionComisionExtra'
        db.delete_table('fed_participacioncomisionextra')

        # Removing M2M table for field municipios on 'ParticipacionComisionExtra'
        db.delete_table('fed_participacioncomisionextra_municipios')
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 23, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.participacioncomisionextra': {
            'Meta': {'object_name': 'ParticipacionComisionExtra'},
            'ambito_territorial': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'comision': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'municipios': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lugar.Municipio']", 'null': 'True', 'blank': 'True'}),
        ...
        'fed.poblacionmetadirecta': {
            ...
            'alcanzada_hombre': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'alcanzada_mujer': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 23, 0, 0)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
