...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PoblacionMetaIndirecta.alcanzada_hombre'
        db.alter_column('fed_poblacionmetaindirecta', 'alcanzada_hombre', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PoblacionMetaIndirecta.alcanzada_mujer'
        db.alter_column('fed_poblacionmetaindirecta', 'alcanzada_mujer', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PoblacionMetaDirecta.alcanzada_hombre'
        db.alter_column('fed_poblacionmetadirecta', 'alcanzada_hombre', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PoblacionMetaDirecta.alcanzada_mujer'
        db.alter_column('fed_poblacionmetadirecta', 'alcanzada_mujer', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PoblacionMetaIndirecta.alcanzada_hombre'
        db.alter_column('fed_poblacionmetaindirecta', 'alcanzada_hombre', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'PoblacionMetaIndirecta.alcanzada_mujer'
        db.alter_column('fed_poblacionmetaindirecta', 'alcanzada_mujer', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'PoblacionMetaDirecta.alcanzada_hombre'
        db.alter_column('fed_poblacionmetadirecta', 'alcanzada_hombre', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'PoblacionMetaDirecta.alcanzada_mujer'
        db.alter_column('fed_poblacionmetadirecta', 'alcanzada_mujer', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
