...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ley'
        db.create_table('contraparte_ley', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('contraparte', ['Ley'])

        # Adding M2M table for field ley on 'AccionImplementada'
        db.create_table('contraparte_accionimplementada_ley', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accionimplementada', models.ForeignKey(orm['contraparte.accionimplementada'], null=False)),
            ('ley', models.ForeignKey(orm['contraparte.ley'], null=False))
        ))
        db.create_unique('contraparte_accionimplementada_ley', ['accionimplementada_id', 'ley_id'])


    def backwards(self, orm):
        
        # Deleting model 'Ley'
        db.delete_table('contraparte_ley')

        # Removing M2M table for field ley on 'AccionImplementada'
        db.delete_table('contraparte_accionimplementada_ley')
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 7)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 7)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 7)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
