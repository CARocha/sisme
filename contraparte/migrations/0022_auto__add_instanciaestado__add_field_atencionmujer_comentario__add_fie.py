...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstanciaEstado'
        db.create_table('contraparte_instanciaestado', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('contraparte', ['InstanciaEstado'])

        # Adding field 'AtencionMujer.comentario'
        db.add_column('contraparte_atencionmujer', 'comentario',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipacionComision.comentario'
        db.add_column('contraparte_participacioncomision', 'comentario',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Denuncia.instancia'
        db.add_column('contraparte_denuncia', 'instancia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.InstanciaEstado'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Denuncia.comentario'
        db.add_column('contraparte_denuncia', 'comentario',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccionImplementada.comentario'
        db.add_column('contraparte_accionimplementada', 'comentario',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InstanciaEstado'
        db.delete_table('contraparte_instanciaestado')

        # Deleting field 'AtencionMujer.comentario'
        db.delete_column('contraparte_atencionmujer', 'comentario')

        # Deleting field 'ParticipacionComision.comentario'
        db.delete_column('contraparte_participacioncomision', 'comentario')

        # Deleting field 'Denuncia.instancia'
        db.delete_column('contraparte_denuncia', 'instancia_id')

        # Deleting field 'Denuncia.comentario'
        db.delete_column('contraparte_denuncia', 'comentario')

        # Deleting field 'AccionImplementada.comentario'
        db.delete_column('contraparte_accionimplementada', 'comentario')
    ...
    models = {
        ...
        'contraparte.accionimplementada': {
            ...
            'ley': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['contraparte.Ley']", 'null': 'True', 'blank': 'True'}),
        ...
        'contraparte.denuncia': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'informe': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contraparte.Informe']"}),
            'instancia': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contraparte.InstanciaEstado']", 'null': 'True', 'blank': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'contraparte.instanciaestado': {
            'Meta': {'object_name': 'InstanciaEstado'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'contraparte.ley': {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 0, 0)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'proyecto_activo': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
