...
urlpatterns = patterns('sisme.contraparte.views',
    ...
    (r'^ver_comentario_comision/(?P<organizacion>[-\w]+)/$', 'ver_comentario_comision'),
    (r'^comentario_org_osc/$', 'comentario_denuncia_osc'),
    (r'^ver_comentario_osc/(?P<organizacion>[-\w]+)/$', 'ver_comentario_osc'),
    (r'^comentario_org_albergues/$', 'comentario_albergue'),
    (r'^ver_comentario_albergues/(?P<organizacion>[-\w]+)/$', 'ver_comentario_albergues'),
)